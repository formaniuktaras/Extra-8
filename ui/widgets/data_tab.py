...
from PySide6.QtWidgets import QHBoxLayout, QPushButton, QSplitter, QToolBar, QVBoxLayout, QWidget
...
class DataTab(QWidget):
    ...
    def __init__(self) -> None:
        ...
        for btn in [self.btn_refresh, self.btn_open, self.btn_diag, self.btn_add, self.btn_new_folder, self.btn_rename, self.btn_delete]:
